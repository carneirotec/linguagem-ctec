...
#defina va_arg(ap, t) ((sizeof(t) > 8 || (sizeof(t) & (sizeof(t) - 1))) \
	? **(t **)((ap += 8) - 8) : *(t  *)((ap += 8) - 8))
#defina va_copy(dest, src) ((dest) = (src))
#defina va_end(ap)
#fim_se
...
#defina va_start(ap,last) ap = ((caractere *)&(last)) + ((sizeof(last)+3)&~3)
#defina va_arg(ap,type) (ap = (vazio *) ((_ctec_align(ap,type)+sizeof(type)+3) \
...
#defina va_start(ap,last) ap = ((caractere *)&(last)) + ((sizeof(last)+3)&~3)
#defina va_arg(ap,type) (ap += (sizeof(type)+3)&~3, *(type *)(ap - ((sizeof(type)+3)&~3)))
#defina va_copy(dest, src) (dest) = (src)
#defina va_end(ap)
#fim_se
