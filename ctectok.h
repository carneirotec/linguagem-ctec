/* keywords */
     ...
     DEF(TOK_UNSIGNED, "sem_sinal")
     DEF(TOK_GOTO, "ir_para")
     DEF(TOK_DO, "faça")
     ...
     DEF(TOK_SIGNED1, "sinalizado")
     DEF(TOK_SIGNED2, "__signed") /* gcc keyword */
     DEF(TOK_SIGNED3, "__signed__") /* gcc keyword */
     DEF(TOK_AUTO, "automático")
     DEF(TOK_INLINE1, "em_linha")
     ...
     DEF(TOK_GENERIC, "_Genérico")

     DEF(TOK_FLOAT, "real")
     DEF(TOK_DOUBLE, "duplo")
     DEF(TOK_BOOL, "_Lógico")
     DEF(TOK_SHORT, "curto")
     DEF(TOK_STRUCT, "estrutura")
     DEF(TOK_UNION, "união")
     DEF(TOK_TYPEDEF, "defina_tipo")
     DEF(TOK_DEFAULT, "padrão")
     DEF(TOK_ENUM, "enumeração")
     DEF(TOK_SIZEOF, "tamaho_de")
     DEF(TOK_ATTRIBUTE1, "__attribute")
     DEF(TOK_ATTRIBUTE2, "__attribute__")
     DEF(TOK_ALIGNOF1, "__alignof")
     DEF(TOK_ALIGNOF2, "__alignof__")
     DEF(TOK_TYPEOF1, "tipo_de")
     DEF(TOK_TYPEOF2, "__typeof")
     DEF(TOK_TYPEOF3, "__typeof__")
     DEF(TOK_LABEL, "__label__")
     DEF(TOK_ASM1, "assembler")
     DEF(TOK_ASM2, "__asm")
...
/* preprocessor only */
     ...
     DEF(TOK_IFDEF, "se_definido")
     DEF(TOK_IFNDEF, "se_não_definido")
     DEF(TOK_ELIF, "senão_se")
     DEF(TOK_ENDIF, "fim_se")
     DEF(TOK_DEFINED, "definido")
     DEF(TOK_UNDEF, "não_definido")
     DEF(TOK_ERROR, "erro")
     ...
     DEF(TOK___VA_ARGS__, "__VARIÁVEIS_ARGS__")
     DEF(TOK___COUNTER__, "__CONTADOR__")

/* special identifiers */
     DEF(TOK___FUNC__, "__função__")

/* special floating point values */
     DEF(TOK___NAN__, "__não_é_número__")
     DEF(TOK___SNAN__, "__não_é_número_sinalizado__")
     DEF(TOK___INF__, "__infinito__")

/* attribute identifiers */
/* XXX: handle all tokens generically since speed is not critical */
     DEF(TOK_SECTION1, "sessão")
     DEF(TOK_SECTION2, "__section__")
     DEF(TOK_ALIGNED1, "alinhado")
     DEF(TOK_ALIGNED2, "__aligned__")
     DEF(TOK_PACKED1, "empacotado")
     DEF(TOK_PACKED2, "__packed__")
     DEF(TOK_WEAK1, "fraco")
     DEF(TOK_WEAK2, "__weak__")
     DEF(TOK_ALIAS1, "pseudônimo")
     DEF(TOK_ALIAS2, "__alias__")
     DEF(TOK_UNUSED1, "não_usado")
     DEF(TOK_UNUSED2, "__unused__")
     DEF(TOK_CDECL1, "declaração")
     DEF(TOK_CDECL2, "__cdecl")
     DEF(TOK_CDECL3, "__cdecl__")
     DEF(TOK_STDCALL1, "chamada_convencional")
     DEF(TOK_STDCALL2, "__stdcall")
     DEF(TOK_STDCALL3, "__stdcall__")
     DEF(TOK_FASTCALL1, "chamada_rápida")
     DEF(TOK_FASTCALL2, "__fastcall")
     DEF(TOK_FASTCALL3, "__fastcall__")
     DEF(TOK_REGPARM1, "parâmetro_registrador")
     DEF(TOK_REGPARM2, "__regparm__")

     DEF(TOK_MODE, "__modo__")
     DEF(TOK_MODE_QI, "__QI__")
     DEF(TOK_MODE_DI, "__DI__")
     DEF(TOK_MODE_HI, "__HI__")
     DEF(TOK_MODE_SI, "__SI__")
     DEF(TOK_MODE_word, "__palavra__")

     DEF(TOK_DLLEXPORT, "exporte_dll")
     DEF(TOK_DLLIMPORT, "importe_dll")
     DEF(TOK_NORETURN1, "sem_retorno")
     DEF(TOK_NORETURN2, "__noreturn__")
     DEF(TOK_VISIBILITY1, "visibilidade")
